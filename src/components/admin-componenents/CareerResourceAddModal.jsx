// src/components/admin-components/CareerResourceAddModal.jsx
...
const CareerResourceAddModal = ({ onClose, onSave }) => {
  const { createCareerResource, loading, error, clearError } = useCareerResources();
  const { user } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createCareerResource(resourceData, token);
      ...
      setErrors(prev => ({ 
        ...prev, 
        submit: err.message || 'Failed to create career resource' 
      }));
    }
  };
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content resource-modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h3>
            <FaPlus /> Add New Career Resource
          </h3>
        ...
        {submitSuccess ? (
          <div className="resource-success">
            ...
            <h4>Career Resource Created Successfully!</h4>
            <p>The resource has been added to the database.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="resource-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="Enter resource title (e.g., 'Malawi University of Science and Technology')"
                disabled={loading}
                maxLength={255}
              />
              {errors.title && (
...
export default CareerResourceAddModal;