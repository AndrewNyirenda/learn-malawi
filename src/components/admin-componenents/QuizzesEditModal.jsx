// src/components/admin-componenents/QuizzesEditModal.jsx
...
const QuizzesEditModal = ({ quiz, onClose, onSave }) => {
  const { updateQuiz, loading, error, clearError } = useQuizzes();
  const { user } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await updateQuiz(quiz.id, quizData, token);
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content large-modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h3>
            <FaQuestionCircle /> Edit Quiz: {quiz.title}
          </h3>
        ...
        {submitSuccess ? (
          <div className="quiz-success">
            ...
            <h4>Quiz Updated Successfully!</h4>
              ...
              <div key={questionIndex} className="question-item">
                <div className="question-header">
                  <div className="question-number">
                    Question {questionIndex + 1} {question.id ? `(ID: ${question.id})` : ''}
                  </div>
                  <button
                    type="button"
