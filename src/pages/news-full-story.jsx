      ...
      <div className="full-story-wrapper">
        ...
        <div className="featured-image-container">
          {imageError ? (
            ...
            >
              <span className="placeholder-text-large">{article.category}</span>
            </div>
          ) : (
            <img 
              ...
              {relatedArticles.map(related => (
                ...
                >
                  ...
                  <div className="related-content">
                    ...
                    <p className="related-description">{related.description.substring(0, 80)}...</p>
                    <div className="related-meta">
                      <span>{formatDate(related.datePublished)}</span>
                      <span>•</span>
